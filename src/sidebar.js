...
const Sidebar = () => {
    return (
        <div>
            <div className="max-w-2xl mx-auto h-screen text-wite  float-left ">
                <aside className="w-64 h-full" aria-label="Sidebar">
                    <div className="px-3 h-full py-4 overflow-y-auto rounded bg-[#131822]  dark:bg-gray-800">
                        <ul className="space-y-2">
                            <li>
                                <a href="/" className="flex items-center p-6 text-base font-normal  rounded-lg text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <li>
                                <button type="button" className="flex items-center w-full p-6 text-base font-normal text-white transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                                    ...
                                    <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>TUTORIAL</span>
                                </button>
                            </li>
                            <li>
                                <a href="/" className="flex items-center p-6 text-base font-normal rounded-lg text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <span className="flex-1 ml-3 whitespace-nowrap">CERTIFICATE</span>
                                </a>
                            </li>
                            <li>
                                <a href="/" className="flex items-center p-6 text-base font-normal rounded-lg text-white hover:bg-gray-100 dark:hover:bg-gray-700">
